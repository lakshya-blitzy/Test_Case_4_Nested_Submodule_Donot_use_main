...
``runner.runner_tests`` package.  `Source: _runner_tests.py:L7-L11`

This module is the command Continuous Integration uses to verify the
runner: Travis runs ``python _runner_tests.py``.  `Source: .travis.yml:L7`
...
`Source: _runner_tests.py:L24-L26`
...
def suite():
    ...
    `Source: _runner_tests.py:L14-L21`
    '''
