...
Source: runner/mountain.py:L24 (the ``Mountain`` class these tests exercise).
'''
...
class TestMountain(unittest.TestCase):
    ...
    Source: runner/mountain.py:L24 (``Mountain`` definition under test).
    '''
    ...
    def setUp(self):
        ...
        Source: runner/mountain.py:L35-L48 (``Mountain.__init__``).
        '''
    ...
    def test_it_gets_test_results(self):
        ...
        Source: runner/mountain.py:L50 (``walk_the_path`` under test) and L57
